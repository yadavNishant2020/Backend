...
app.get("/random", (req, res) => {
  ...
  res.json(jokes[randomJokeIndex]);
});
...
app.get("/filter", (req, res) => {
  ...
  const filterJoke = jokes.filter((joke) => {
...
app.post("/jokes", (req, res) => {
  ...
  jokes.push(newJoke);
  //log the last joke of the array using slice
...
app.put("/jokes/:id", (req, res) => {
  ...
  const newJoke = (jokes[searchIndex] = updatedJoke);
  res.json(newJoke);
});
